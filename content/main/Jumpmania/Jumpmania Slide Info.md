...
- If you start a slide while *not* dashing, you instead receive a multiplier to your speed (or an addition of 80 speed if you are going slow enough that that is greater than the multiplier.) This multiplier ranges from 1.25 to 1.1, getting smaller as you go faster. It is at 1.25x at 600 speed (a bit faster than dashing) and below, and linearly reduces until it reaches 1.1x at 2000 speed.
